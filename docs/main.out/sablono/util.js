...
var len__6046__auto___10188 = arguments.length;
var i__6047__auto___10189 = (0);
while(true){
if((i__6047__auto___10189 < len__6046__auto___10188)){
args__6053__auto__.push((arguments[i__6047__auto___10189]));

var G__10190 = (i__6047__auto___10189 + (1));
i__6047__auto___10189 = G__10190;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq10187){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq10187));
});
/**
...
var vec__10192 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__10192,(0),null);
var words = cljs.core.nthnext.call(null,vec__10192,(1));
...
var G__10194 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__10194,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__10194;
}
} else {
...
var args__6053__auto__ = [];
var len__6046__auto___10197 = arguments.length;
var i__6047__auto___10198 = (0);
while(true){
if((i__6047__auto___10198 < len__6046__auto___10197)){
args__6053__auto__.push((arguments[i__6047__auto___10198]));

var G__10199 = (i__6047__auto___10198 + (1));
i__6047__auto___10198 = G__10199;
continue;
} else {
}
break;
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__10195_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__10195_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__10195_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__10195_SHARP_)){
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq10196){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq10196));
});
/**
...
var tag_name = cljs.core.nth.call(null,vec__10203,(0),null);
var names = cljs.core.nth.call(null,vec__10203,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__10203,tag_name,names){
return (function (p1__10200_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__10200_SHARP_));
});})(matches,vec__10203,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__10203,tag_name,names){
return (function (p1__10201_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__10201_SHARP_));
});})(matches,vec__10203,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__10204){
var vec__10207 = p__10204;
var tag = cljs.core.nth.call(null,vec__10207,(0),null);
var content = cljs.core.nthnext.call(null,vec__10207,(1));
...
var vec__10208 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__10208,(0),null);
var id = cljs.core.nth.call(null,vec__10208,(1),null);
var class$ = cljs.core.nth.call(null,vec__10208,(2),null);
