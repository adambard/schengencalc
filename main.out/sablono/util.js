...
var m__5644__auto__ = (sablono.util.to_str[goog.typeOf(x__5643__auto__)]);
if(!((m__5644__auto__ == null))){
return m__5644__auto__.call(null,x);
} else {
var m__5644__auto____$1 = (sablono.util.to_str["_"]);
...
var x__5643__auto__ = (((x == null))?null:x);
var m__5644__auto__ = (sablono.util.to_uri[goog.typeOf(x__5643__auto__)]);
if(!((m__5644__auto__ == null))){
return m__5644__auto__.call(null,x);
} else {
var m__5644__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__5644__auto____$1 == null))){
return m__5644__auto____$1.call(null,x);
} else {
...
var len__6046__auto___11447 = arguments.length;
var i__6047__auto___11448 = (0);
while(true){
if((i__6047__auto___11448 < len__6046__auto___11447)){
args__6053__auto__.push((arguments[i__6047__auto___11448]));

var G__11449 = (i__6047__auto___11448 + (1));
i__6047__auto___11448 = G__11449;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__6054__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq11446){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq11446));
});
/**
...
var vec__11451 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__11451,(0),null);
var words = cljs.core.nthnext.call(null,vec__11451,(1));
...
var G__11453 = clojure.set.rename_keys.call(null,m,kmap);
var G__11453__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__11453,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__11453);
return G__11453__$1;
} else {
return m;
}
...
var args__6053__auto__ = [];
var len__6046__auto___11456 = arguments.length;
var i__6047__auto___11457 = (0);
while(true){
if((i__6047__auto___11457 < len__6046__auto___11456)){
args__6053__auto__.push((arguments[i__6047__auto___11457]));

var G__11458 = (i__6047__auto___11457 + (1));
i__6047__auto___11457 = G__11458;
continue;
} else {
}
break;
...
var argseq__6054__auto__ = ((((0) < args__6053__auto__.length))?(new cljs.core.IndexedSeq(args__6053__auto__.slice((0)),(0))):null);
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__6054__auto__);
});

sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic = (function (maps){
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__11454_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__11454_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__11454_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__11454_SHARP_)){
return p1__11454_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__11454_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq11455){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq11455));
});
/**
...
var vec__11462 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__11462,(0),null);
var names = cljs.core.nth.call(null,vec__11462,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__11462,tag_name,names){
return (function (p1__11459_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__11459_SHARP_));
});})(matches,vec__11462,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__11462,tag_name,names){
return (function (p1__11460_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__11460_SHARP_));
});})(matches,vec__11462,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__11463){
var vec__11466 = p__11463;
var tag = cljs.core.nth.call(null,vec__11466,(0),null);
var content = cljs.core.nthnext.call(null,vec__11466,(1));
...
var vec__11467 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__11467,(0),null);
var id = cljs.core.nth.call(null,vec__11467,(1),null);
var class$ = cljs.core.nth.call(null,vec__11467,(2),null);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__4988__auto__ = x__$1.hasDomain();
