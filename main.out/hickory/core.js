...
var pred__10127 = cljs.core._EQ_;
var expr__10128 = (this$["nodeType"]);
if(cljs.core.truth_(pred__10127.call(null,hickory.core.Attribute,expr__10128))){
...
var pred__10130 = cljs.core._EQ_;
var expr__10131 = (this$["nodeType"]);
if(cljs.core.truth_(pred__10130.call(null,hickory.core.Attribute,expr__10131))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hickory.utils.lower_case_keyword.call(null,(this$["name"])),(this$["value"])], null);
} else {
if(cljs.core.truth_(pred__10130.call(null,hickory.core.Comment,expr__10131))){
...
if(cljs.core.truth_(pred__10130.call(null,hickory.core.Document,expr__10131))){
...
if(cljs.core.truth_(pred__10130.call(null,hickory.core.DocumentType,expr__10131))){
...
if(cljs.core.truth_(pred__10130.call(null,hickory.core.Element,expr__10131))){
...
if(cljs.core.truth_(pred__10130.call(null,hickory.core.Text,expr__10131))){
return (this$["wholeText"]);
} else {
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__10131)].join('')));
}
}
}
}
...
var temp__4425__auto__ = cljs.core.second.call(null,(function (){var or__4988__auto__ = cljs.core.re_find.call(null,/<!DOCTYPE ([^>]*)>/,s);
...
var temp__4425__auto___10133 = cljs.core.first.call(null,(doc["head"]["childNodes"]));
if(cljs.core.truth_(temp__4425__auto___10133)){
var title_el_10134 = temp__4425__auto___10133;
if(cljs.core.empty_QMARK_.call(null,(title_el_10134["text"]))){
hickory.core.remove_el.call(null,title_el_10134);
} else {
}
} else {
}
